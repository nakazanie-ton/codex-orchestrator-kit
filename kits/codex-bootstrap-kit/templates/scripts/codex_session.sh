...
1) .local_codex/CONTEXT_COMPACT.md (key AGENT_STATE + verification summary, if present)
2) .local_codex/CODEX_LOCAL_CHECKLIST.md (confirm status: PASS)
3) .local_codex/PROJECT_AGENT_STATE.json
4) .local_codex/PROJECT_NAVIGATION.md
5) .local_codex/PROJECT_DEPENDENCY_GRAPH.md
6) .local_codex/PROJECT_TREE.txt
